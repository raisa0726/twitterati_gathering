...
from flask import render_template, request, redirect,current_app,jsonify,request
...
def home():
	...
	return jsonify(user=users, groups=groups)
...
def create():
  ...
  if request.method == "POST":
    ...
    return render_template("/group/create")
...
def join():
  if request.method == "POST":
    ...
    return render_template("/group/join")
...
def edit(group_id):
  ...
  if request.method == "GET":
    return render_template("/group/edit", group=group)
